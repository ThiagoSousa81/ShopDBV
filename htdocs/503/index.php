...
{?>
      <header>
        <div class="antinfo" style="display: flex">
            <img src="/system/images/Branco.png" alt="" style="width: 20%;border-color: gray;background-color: white;border-radius: 10%">
...
// <------< confirmadamente correto
    echo '<h3 style="text-align: center">Erro 503 - Service Unavailable</h3>';
?>   
