...
<?php
session_start();
$cls->conectar("xxxxxxxxxx", "xxxxxxxxx", "xxxxxxxxxxx", "xxxxxxxxxx");
...
<?php   
    $link = "/system/p/almofada/action.php";
}
else
{?>
      <header>
            ...
            <div class="u-layout-row">
              <div class="u-size-30 u-size-60-md">
                <div class="u-layout-col">
                  <div class="u-container-style u-image u-layout-cell u-left-cell u-size-60 u-image-1" src="" data-image-width="391" data-image-height="429" style="
    background-image: url(images/travesseiro.png);
    background-size: 75% 100%;
">
                    <div class="u-container-layout u-valign-middle u-container-layout-1"></div>
                  </div>
                <div class="u-container-style u-image u-layout-cell u-left-cell u-size-60 u-image-1" src="" data-image-width="391" data-image-height="429" style="
    background-image: url(images/verso-travesseiro.png);
    background-size: 75% 100%;
"></div>
                    <div class="u-container-layout u-valign-middle u-container-layout-1"></div>
                  </div></div>
                    ...
                    <div class="u-layout-row">
                      <div class="u-align-left u-container-style u-layout-cell u-size-60 u-layout-cell-2">
                        <div class="u-container-layout u-valign-top u-container-layout-2">
                          ...
                          <p class="u-text u-text-2">Descrição do produto:<br><br>Almofada com estampa da bandeira dos desbravadores</p>
                        </div>
                      </div>
                    </div>
                  </div>
