...
<?php
session_start();
$cls->conectar("xxxxxxxxx", "xxxxxxxxx", "xxxxxxxx", "xxxxxxxxxxx");
...
<?php
    ...
    exit;*/
    $link = "/system/p/cofrinho/action.php";
}
else
{?>
      <header>
            ...
            <div class="u-layout-row">
              <div class="u-size-30 u-size-60-md">
                <div class="u-layout-col">
                  <div class="u-container-style u-image u-layout-cell u-left-cell u-size-60 u-image-1" src="/system/images/Cofrinho.jpg" data-image-width="391" data-image-height="429">
                    ...
                    <div class="u-layout-row">
                      <div class="u-align-left u-container-style u-layout-cell u-size-60 u-layout-cell-2">
                        <div class="u-container-layout u-valign-top u-container-layout-2">
                          ...
                          <p class="u-text u-text-2">Código do produto: <?php echo $producto[0];?></p>
                          <p class="u-text u-text-2">Quantidade disponível: <?php echo $producto[3];?></p>
                          <p class="u-text u-text-2">Descrição do produto:<br><br>Cofrinho de madeira com emblema D1</p>
                        </div>
                      </div>
                    </div>
                  </div>
