...
<?php
session_start();
$cls->conectar("xxxxx", "xxxxxxx", "xxxxxxxx", "xxxxxxx");
...
<?php
    ...
    exit;*/
    $link = "/system/p/bp1000011/action.php";
}
else
{?>
      <header>
                    ...
                    <div class="u-layout-row">
                      <div class="u-align-left u-container-style u-layout-cell u-size-60 u-layout-cell-2">
                        <div class="u-container-layout u-valign-top u-container-layout-2">
                          ...
                          <p class="u-text u-text-2">Descrição do produto:<br><br>Sacola de tecido com emblema do desbravador<br>Fundo: Azul<br>Frente: Azul<br>Emblema: D1<br>Cor da listra: Azul</p>
                        </div>
                      </div>
                    </div>
                  </div>
