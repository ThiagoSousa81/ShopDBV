...
<?php
session_start();
$cls->conectar("xxxxxxxxxxx", "xxxxxxxxx", "xxxxxxxx", "xxxxxxxxxxx");
...
<?php
    ...
    exit;*/
    $link = "/system/p/bp1000041/action.php";
}
else
{?>
      <header>
            ...
            <div class="u-layout-row">
              <div class="u-size-30 u-size-60-md">
                <div class="u-layout-col">
                  <div class="u-container-style u-image u-layout-cell u-left-cell u-size-60 u-image-1" src="/system/images/Sacola.jpg" data-image-width="391" data-image-height="429">
                    ...
                    <div class="u-layout-row">
                      <div class="u-align-left u-container-style u-layout-cell u-size-60 u-layout-cell-2">
                        <div class="u-container-layout u-valign-top u-container-layout-2">
                          ...
                          <p class="u-text u-text-2">Val&ZeroWidthSpace;&ZeroWidthSpace;or: <?php echo $preco;?><span class="u-file-icon u-icon u-icon-1"><img src="images/star.png" alt=""></span>                          
                          </p>
                          <p class="u-text u-text-2">Quantidade disponível: Peça única</p>
                          <p class="u-text u-text-2">Descrição do produto:<br><br>Sacola de tecido com emblema do desbravador<br>Fundo: Branco<br>Frente: Branca<br>Emblema: D1<br>Cor da listra: Azul</p>
                        </div>
                      </div>
                    </div>
                  </div>
