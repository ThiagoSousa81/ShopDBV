...
{ //Thiago Sousa -> 926380
  ...
  $cls->conectar("xxxxxxxxx", "xxxxxxxxx", "xxxxxxxx", "xxxxxxxxxxxx");
    
    $now = new DateTime();
    $date = $now->format('Y/m/d');
    $hour = $now->format('H:i');

    $cls->InsertCart($_SESSION['ID_USER'], 1000008, 0, 'NO CARRINHO', $hour, $date);
...
<?php
    ...
    echo '<h3 style="text-align: center">Item adicionado ao carrinho com sucesso!</h3>';
?>   
