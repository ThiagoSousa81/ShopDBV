...
<?php
session_start();
$cls->conectar("xxxxxxxxxxx", "xxxxxxxxxxxx", "xxxxxxxxxxx", "xxxxxxxxxx");
...
<?php
    ...
    exit;*/
    $link = "/system/p/caneta/action.php";
}
else
{?>
      <header>
...
$producto = $cls->GetProd('1000008');
global $Blue;

$R = $cls->GetProd('1100008');
$Blue = $cls->GetProd('1200008');
$Black = $cls->GetProd('1300008');
$White = $cls->GetProd('1400008');
?>
                    ...
                    <div class="u-layout-row">
                      <div class="u-align-left u-container-style u-layout-cell u-size-60 u-layout-cell-2">
                        <div class="u-container-layout u-valign-top u-container-layout-2">
                          ...
                          <p class="u-text u-text-2">Descrição do produto:<br><br>Canetas de tinta azul Estrelas da Cruz<br><br>Quantidade disponível: <?php echo $R[3] + $Blue[3] + $Black[3] + $White[3]?><br>Nas cores<br><br>
                          <span class="u-file-icon u-icon u-icon-1">
                            <img src="/system/images/Red.png" alt="">
                            </span> <?php echo $R[3].'           Cod.: '.$R[0];?> <br>
                          <span class="u-file-icon u-icon u-icon-1">
                            <img src="/system/images/Blue.png" alt="">
                          </span> <?php echo $Blue[3].'           Cod.: '.$Blue[0];?> <br>
                            <span class="u-file-icon u-icon u-icon-1">
                            <img src="/system/images/Black.png" alt="">
                          </span> <?php echo $Black[3].'           Cod.: '.$Black[0];?> <br>
                          <span class="u-file-icon u-icon u-icon-1">
                            <img src="/system/images/White.png" alt="">
                          </span> <?php echo $White[3].'           Cod.: '.$White[0];?> 
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="u-align-left u-container-style u-layout-cell u-size-60 u-layout-cell-3">
                        ...
                        <?php 
                          if ($dados[5] == 'DIRETORIA') {
                            ...
                            echo '<a href="/system/p/caneta/action-red.php" class="u-align-center u-border-2 u-border-black u-btn u-btn-round u-button-style u-hover-custom-color-3 u-none u-radius-50 u-text-hover-white u-btn-1" style="width: 50%;" method="POST"><img src="/system/images/Red.png" alt="" style="width: 10px; margin-inline-end: 10px;">ADICIONAR VERMELHA AO CARRINHO&nbsp;&nbsp;</a>';
                            echo '<a href="/system/p/caneta/action-blue.php" class="u-align-center u-border-2 u-border-black u-btn u-btn-round u-button-style u-hover-custom-color-3 u-none u-radius-50 u-text-hover-white u-btn-1" style="width: 50%;" method="POST"><img src="/system/images/Blue.png" alt="" style="width: 10px; margin-inline-end: 10px;">ADICIONAR AZUL AO CARRINHO&nbsp;&nbsp;</a>';
                            echo '<a href="/system/p/caneta/action-black.php" class="u-align-center u-border-2 u-border-black u-btn u-btn-round u-button-style u-hover-custom-color-3 u-none u-radius-50 u-text-hover-white u-btn-1" style="width: 50%;" method="POST"><img src="/system/images/Black.png" alt="" style="width: 10px; margin-inline-end: 10px;">ADICIONAR PRETA AO CARRINHO&nbsp;&nbsp;</a>';                              
                            echo '<a href="/system/p/caneta/action-white.php" class="u-align-center u-border-2 u-border-black u-btn u-btn-round u-button-style u-hover-custom-color-3 u-none u-radius-50 u-text-hover-white u-btn-1" style="width: 50%;" method="POST"><img src="/system/images/White.png" alt="" style="width: 10px; margin-inline-end: 10px;">ADICIONAR BRANCA AO CARRINHO&nbsp;&nbsp;</a>';                            
                          }?>
