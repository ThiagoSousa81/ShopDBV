...
<?php
session_start();
$cls->conectar("xxxxxxxxxx", "xxxxxxxx", "xxxxxx", "xxxxxxxx");
...
<?php
    $link = "/system/p/mousepad/action.php";
}
else
{?>
      <header>
                    ...
                    <div class="u-layout-row">
                      <div class="u-align-left u-container-style u-layout-cell u-size-60 u-layout-cell-2">
                        <div class="u-container-layout u-valign-top u-container-layout-2">
                          ...
                          <p class="u-text u-text-2">Descrição do produto:<br><br>Mouse-pad para mouse óptico com emblema D1</p>
                        </div>
                      </div>
                    </div>
                  </div>
